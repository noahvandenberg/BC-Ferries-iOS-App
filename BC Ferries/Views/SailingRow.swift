                        ...
                        if !sailing.isCancelled {
                            ...
                            Capsule()
                                .fill(
                                    LinearGradient(
                                        colors: [
                                            progress == 0 ? Color.purple : Color.blue,
                                            (progress == 0 ? Color.purple : Color.blue).opacity(0.5)
                                        ],
                                        startPoint: .leading,
                                        endPoint: .trailing
                                    )
                                )
                                .frame(width: max(4, progress * 100), height: 4)
                            
                            // Ferry icon
                            Image(systemName: "ferry.fill")
                                .font(.caption2)
                                .foregroundStyle(progress == 0 ? Color.purple : Color.blue)
                                .background(
                                    Circle()
                                        .fill(.background)
                                        .padding(2)
                                )
                                .offset(x: (progress * 100) - 8)
                        }
                    }
